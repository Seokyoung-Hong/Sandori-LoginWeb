...
def make_pages() -> dict[str, str]:
    ...
    verify = auth_card(
        ...
        '''<div class="sandori-info-card">인증 메일의 링크를 눌러야 Sandori 서비스를 계속 이용할 수 있습니다. 메일이 보이지 않으면 스팸함도 확인해 주세요.</div><form class="sandori-form"><button class="sandori-btn sandori-btn-login">인증 메일 다시 보내기</button></form><footer><div class="sandori-footer-link-block"><a href="#">로그인으로 돌아가기</a></div></footer>''',
...
<tr><td style="font-size:14px;line-height:1.7;color:#4D4D4D;text-align:center;padding-bottom:24px;">Sandori 서비스를 계속 이용하려면 아래 버튼을 눌러 이메일 인증을 완료해 주세요.</td></tr>
