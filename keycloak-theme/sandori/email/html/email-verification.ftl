...
<tr><td align="center"><a href="${link}" style="display:inline-block;background:#4EA6AA;color:#ffffff;text-decoration:none;font-size:15px;font-weight:700;padding:14px 28px;border-radius:12px;">이메일 인증하기</a></td></tr>
